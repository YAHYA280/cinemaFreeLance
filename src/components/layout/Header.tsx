          ...
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden xl:flex items-center gap-0.5">
              {navLinks.map((link) => (
                <Link
                  ...
                  href={link.href}
                  className={cn(
                    'px-2.5 py-2 text-xs font-medium text-[var(--color-silver)] hover:text-[var(--color-gold)] transition-colors relative group whitespace-nowrap',
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="xl:hidden p-2 text-[var(--color-gold)]"
